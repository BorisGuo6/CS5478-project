...
class ImgEncoder(nn.Module):
    ...
    def __init__(self, input_dim, latent_dim):
        ...
        self.elu = nn.ELU()
        print(f"Encoder initialized with input_dim: {input_dim} latent_dim: {latent_dim}")
    ...
    def define_encoder(self):
        ...
        self.conv1_jump_3 = nn.Conv2d(64, 128, kernel_size=5, stride=4, padding=(2, 2))
        ...
        print("Encoder network initialized: RESNET8")
